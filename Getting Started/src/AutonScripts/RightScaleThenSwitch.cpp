/*
 * RightScaleThenSwitch.cpp
 *
 *  Created on: Apr 16, 2018
 *      Author: PatriotRobotics
 */

#include <AutonScripts/RightScaleThenSwitch.h>

RightScaleThenSwitch::RightScaleThenSwitch(RobotLogic * bot) : AutonScript(2, bot){
	int numPoints_1 = 4;
...
void RightScaleThenSwitch::RunScript(){
	bot->AutonMoveArm();
	switch(stage){
	case 0: {
...
void RightScaleThenSwitch::CheckFlags(){
	switch(stage){
	case 0: {
...
RightScaleThenSwitch::~RightScaleThenSwitch() {
