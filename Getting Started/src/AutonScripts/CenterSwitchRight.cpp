/*
 * CenterSwitchRight.cpp
 *
 *  Created on: Mar 10, 2018
 *      Author: patriotrobotics
 */

#include <AutonScripts/CenterSwitchRight.h>

CenterSwitchRight::CenterSwitchRight(RobotLogic * bot) : AutonScript(1, bot){
	int numPoints_1 = 3;
	Waypoint * points_1 = (Waypoint*)malloc(numPoints_1 * sizeof(Waypoint));
	Waypoint p11 ={0, 0, 0};
	Waypoint p12 = {1.5, -0.75, d2r(-20)};
	Waypoint p13 = {3.85, -1.25, 0};
	points_1[0] = p11;
	points_1[1] = p12;
	points_1[2] = p13;
...
void CenterSwitchRight::RunScript(){
	switch(stage){
	case 0: {
...
void CenterSwitchRight::CheckFlags(){
	switch(stage){
	case 0: {
